...
class Capture (object):
	...
	def displayimg(self): ##We wait until the camera is ready to take a picture.
		...
		if self.background:
			...
			#os.system("import -window 0x05a00009 -resize 640 orbitertemp.bmp") ##Writing a temporary image, which we grab immediately after...
			
			#os.system("xwd -id 0x06600009 | convert - orbitertemp.jpg")
			
			os.system("xwd -name 'Default - Wine desktop' | convert - orbitercap.png")
			...
			currtestimage = pygame.image.load('orbitercap.png')
			#os.remove('orbitertemp.jpg') ##Just in case.
			
			pygame.transform.scale(currtestimage, (320, 240)) ##rescaling to 320, 240. Doesn't speed up shit.
			
			self.testimagearray = pygame.surfarray.array3d(currtestimage)
